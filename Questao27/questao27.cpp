    ...
    for (int k = 0; k < grayImage.rows; k++) {
        for (int l = 0; l < grayImage.cols; l++) {
            if (grayImage.at<uchar>(k, l) == 0 && sampleImage.at<uchar>(k, l) == 0) {
                ...
                imwrite("C:/Users/User/Desktop/GIT/LapiscoComputerVisionRepo/images/variosobjetos.jpg/Results/27_colored_images_auto_region_growing.jpg",
                    unitRegionGrowing);
            }
        }
    }
...
int main() {
    ...
    img = imread("C:/Users/User/Desktop/GIT/LapiscoComputerVisionRepo/images/variosobjetos.jpg", 1);
