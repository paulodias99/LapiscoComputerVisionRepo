...
int main()
{
	Mat color = imread("C:/Users/User/Desktop/GIT/LapiscoComputerVisionRepo/images/variosobjetos.jpg", 1); //Imagem colorida 

	Mat gray; //Imagem em tons de cinza

	cvtColor(color, gray, COLOR_RGB2GRAY); //Converter para tons de cinza
